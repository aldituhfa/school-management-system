...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <!-- Sidebar -->
            <aside id="layout-menu" class="layout-menu menu-vertical bg-menu-theme p-3" style="width:250px;">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a href="#" class="nav-link">
                            <i class="bx bx-bar-chart me-2"></i> Laporan
                        </a>
                    </li>

                    <!-- Account (Dropdown) pakai Bootstrap Collapse -->
                    <li class="nav-item mb-2">
                        <a class="nav-link d-flex align-items-center" data-bs-toggle="collapse" href="#accountMenu" role="button"
