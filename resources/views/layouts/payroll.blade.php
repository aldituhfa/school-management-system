...
<head>
    ...
    <title>Payroll Panel - SMK Taruna Bhakti</title>
                ...
                <div class="navbar-nav ms-auto">
                    <div class="nav-item dropdown user-dropdown">
                        <a href="#" class="nav-link d-flex align-items-center p-0" data-bs-toggle="dropdown">
                            <div class="avatar me-2">P</div>
                            <span class="d-none d-md-inline" style="font-size: 0.8125rem;">Payroll</span>
                ...
                <div class="page-header d-print-none mb-4">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <div class="page-subtitle">Panel Payroll - SMK Taruna Bhakti</div>
                        </div>
                        <div class="col-auto">
