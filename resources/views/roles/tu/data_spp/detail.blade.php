                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                        <form method="POST" action="{{ route('tu.data_spp.cancel', $t->id) }}" onsubmit="return confirm('Batalkan pembayaran bulan {{ $t->bulan }}?')">
                          @csrf
              ...
              <div class="modal fade" id="editModal{{ $t->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $t->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <form method="POST" action="{{ route('tu.data_spp.update', $t->id) }}">
                      @csrf
