...
<div class="container mt-3">
    <h3>Manajemen Akun Guru</h3>

    <!-- Tombol Tambah -->
    <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#addGuruModal">
        + Tambah Guru
    </button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" 
                        data-bs-target="#editGuruModal{{ $u->id }}">
                        Edit
                    </button>

                    <!-- Modal Edit -->
                    <div class="modal fade" id="editGuruModal{{ $u->id }}" tabindex="-1">
...
<div class="modal fade" id="addGuruModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('account.store', 'guru') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
