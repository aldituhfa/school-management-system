...
<div class="container mt-3">
    ...
    <!-- Tombol Tambah -->
    <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#addSiswaModal">
        + Tambah Siswa
    </button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" 
                        data-bs-target="#editSiswaModal{{ $u->id }}">
                        Edit
                    </button>

                    <!-- Modal Edit -->
                    <div class="modal fade" id="editSiswaModal{{ $u->id }}" tabindex="-1">
...
<div class="modal fade" id="addSiswaModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('account.store', 'siswa') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
